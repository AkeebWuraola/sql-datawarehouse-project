...
| date_of_birth    | DATE          | The date of birth of the customer, formatted as YYYY-MM-DD (e.g., 1971-10-06).               |
| customer_creation_date  | DATE   | The date and time when the customer record was created in the system|
